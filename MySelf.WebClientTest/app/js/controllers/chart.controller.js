myselflogApp.controller('ChartController',
    ['$scope', '$log', '$timeout',
function ($scope, $log, $timeout) {
    $scope.data = [
        { x: new Date(13, 10, 1), values: 0 },
        { x: new Date(13, 10, 1), values: 0 },
        { x: new Date(13, 10, 2), values: 10 },
        { x: new Date(13, 10, 3), values: 7 },
        { x: new Date(13, 10, 4), values: 20 }
    ...
    $scope.options = {
        ...
        series: [
          { y: "values", label: "Values", color: "#9467bd" }
        ],
        lineMode: "linear",
        tooltipMode: "default"
    };
